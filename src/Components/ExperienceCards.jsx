...
const SectionWrapper = (Component, idName) => 
  ...
  const ExperienceCard = ({ index, name, description, tags, image, source_code_link, demo_link,date }) => {
    return (
      <motion.div
      ...
      >
        <Tilt
          ...
          <div className="mt-3">
            ...
            <div className="text-white font-bold text-[15px]">{date}</div>
            <p className="mt-2 text-secondary text-[14px] leading-[18px] overflow:auto">{description}</p>
          </div>
          <div
